...
| `add_egovframe_components` | 공통컴포넌트 선택 조립 — M1은 `dryRun` 미리보기(의존성 포함 설치 순서·규모) |
...
1. 공통컴포넌트 선택 설치 — **M1 진행 중** (카탈로그·`list_egovframe_components`·`add_egovframe_components` dryRun 완료, 설계: [docs/design-components-parameter.md](docs/design-components-parameter.md))
